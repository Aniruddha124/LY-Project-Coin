...
static int AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc<2 || IsArgSet("-?") || IsArgSet("-h") || IsArgSet("-help"))
    {
        ...
        std::string strUsage = strprintf(_("%s vercoin-tx utility version"), _(PACKAGE_NAME)) + " " + FormatFullVersion() + "\n\n" +
            _("Usage:") + "\n" +
              "  vercoin-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded vercoin transaction") + "\n" +
              "  vercoin-tx [options] -create [commands]   " + _("Create hex-encoded vercoin transaction") + "\n" +
              "\n";
