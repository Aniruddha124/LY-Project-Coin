...
const char * const BITCOIN_CONF_FILENAME = "vercoin.conf";
const char * const BITCOIN_PID_FILENAME = "vercoin.pid";
...
#ifdef WIN32
    // Windows
    return GetSpecialFolderPath(CSIDL_APPDATA) / "Vercoin";
#else
    fs::path pathRet;
...
#ifdef MAC_OSX
    // Mac
    return pathRet / "Library/Application Support/Vercoin";
#else
    // Unix
    return pathRet / ".vercoin";
#endif
#endif
}
