...
{
    const char* pszTimestamp = "On this day in 11th Jan, 2023 we started creation of VerCoin";
    const CScript genesisOutputScript = CScript() << ParseHex("042384710fa689ad5023690c80f3a49c8f13f8d45b8c857fbcbc8bc4a8e4d3eb4b10f4d4604fa08dce601aaf0f470216fe1b51850b4acf21b179c45070ac7b03a9") << OP_CHECKSIG;
...
public:
    CMainParams() {
        strNetworkID = "main";
        consensus.nSubsidyHalvingInterval = 5256000; // 24 x 60 x 365 x 1
        ...
        genesis = CreateGenesisBlock(1673434061, 2000742599, 0x1e0ffff0, 1, 100* COIN);
        consensus.hashGenesisBlock = genesis.GetHash();
        assert(consensus.hashGenesisBlock == uint256S("0xcdec130746e17d00fbfccf0a062a2bd08946c8df6f81d90d3d8af4740bba71c3"));
        assert(genesis.hashMerkleRoot == uint256S("0x9ad8474a4cf983321a8d42f3f144957ddada6cf51e8ca4591c55a732a9bcfec6"));

        // Note that of those with the service bits flag, most only support a subset of possible options
        vSeeds.push_back(CDNSSeedData("loshan.co.uk", "seed-a.vercoin.loshan.co.uk", true)); //TODO update IP
        // vSeeds.push_back(CDNSSeedData("thrasher.io", "dnsseed.thrasher.io", true));
        // vSeeds.push_back(CDNSSeedData("vercointools.com", "dnsseed.vercointools.com"));
        // vSeeds.push_back(CDNSSeedData("vercoinpool.org", "dnsseed.vercoinpool.org"));
        ...
        checkpointData = (CCheckpointData) {
            ...
            (  0, uint256S("0xcdec130746e17d00fbfccf0a062a2bd08946c8df6f81d90d3d8af4740bba71c3"))
        ...
        chainTxData = ChainTxData{
            ...
            1673434061, // * UNIX timestamp of last known number of transactions
...
public:
    CTestNetParams() {
        ...
        genesis = CreateGenesisBlock(1673434061, 2685235, 0x1e0ffff0, 1, 100 * COIN);
        consensus.hashGenesisBlock = genesis.GetHash();
        assert(consensus.hashGenesisBlock == uint256S("0x81df233b36f11aa31e22e3b893793e419212061faa65b3ca2caa58d7f45b55fd "));
        assert(genesis.hashMerkleRoot == uint256S("0x9ad8474a4cf983321a8d42f3f144957ddada6cf51e8ca4591c55a732a9bcfec6"));

        vFixedSeeds.clear();
        vSeeds.clear();
        // nodes with support for servicebits filtering should be at the top
        vSeeds.push_back(CDNSSeedData("vercointools.com", "testnet-seed.vercointools.com")); //TODO update IP for main net
        vSeeds.push_back(CDNSSeedData("loshan.co.uk", "seed-b.vercoin.loshan.co.uk", true));
        ...
        checkpointData = (CCheckpointData) {
            boost::assign::map_list_of
            ( 0, uint256S("0x81df233b36f11aa31e22e3b893793e419212061faa65b3ca2caa58d7f45b55fd")),
        };
...
public:
    CRegTestParams() {
        ...
        genesis = CreateGenesisBlock(1673434061, 0, 0x207fffff, 1, 100 * COIN);
        consensus.hashGenesisBlock = genesis.GetHash();
        assert(consensus.hashGenesisBlock == uint256S("0x9ca0f4c4c9159b3a9f5eff65656c44c4627db914fad8773b78e2158ce680835b "));
        assert(genesis.hashMerkleRoot == uint256S("0x9ad8474a4cf983321a8d42f3f144957ddada6cf51e8ca4591c55a732a9bcfec6"));
        ...
        checkpointData = (CCheckpointData){
            boost::assign::map_list_of
            ( 0, uint256S("0x9ca0f4c4c9159b3a9f5eff65656c44c4627db914fad8773b78e2158ce680835b"))
        };
